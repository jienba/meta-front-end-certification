...
/*  Just above the for loop in the letterFinder function definition, declare a variable
     named condition1 and assign to it the following code:
      typeof(word) == 'string' && word.length >= 2. */

/* Declare a variable named condition2 on the next line and assign to it and
...
/*  Write an if statement on the next line that checks that condition1 is true,
...
/*     As a failing test, run the letterFinder function and pass it with any two numbers
 as arguments.
 */
/*     As a passing test, run the letterFinder function and pass it with correct 
...
// call the function with wrongs argument
letterFinder(2, 4)
// call the function with corrects argument
letterFinder("cat", "c");